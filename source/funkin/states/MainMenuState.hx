...
class MainMenuState extends FlxState
{
   ...
   * version Shit
   */
  public static var horizonVersion:String = Application.current.meta.get('version'); // used for Discord RPC too

  /**
   * Original Game Version
   */
  public static var funkinVersion:String = "0.8.0"; // used for Discord RPC too
  ...
  var optionShit:Array<String> = ['story_mode', 'freeplay', 'option', 'credits']; // var optionShit:Array<String> = ['story_mode', 'freeplay', #if MODS_ALLOWED 'mods', #end 'credits'];
  var magenta:FlxSprite;
  var camFollow:FlxObject;

  var fileShit:String = "states/mainmenu/";
  ...
  override function create()
  {
    ...
    var psychVer:FlxText = new FlxText(12, FlxG.height - 44, 0, "Horizon Engine v" + horizonVersion, 12);
  ...
  function createMenuItem(name:String, x:Float, y:Float):FlxSprite
  {
    ...
    menuItem.frames = Paths.getSparrowAtlas(fileShit + 'ui/menu_$name');
  ...
  {
    if (FlxG.sound.music.volume < 0.8) FlxG.sound.music.volume = Math.min(FlxG.sound.music.volume + 0.5 * elapsed, 0.8);
